...
hittable_list random_scene() {
    ...
    world.add(make_shared<sphere>(point3(0.0, 1.0, 0.0), 1.0, material_1));

    auto material_2 = make_shared<lambertian>(color(0.4, 0.2, 0.1));
    world.add(make_shared<sphere>(point3(-4.0, 1.0, 0.0), 1.0, material_2));

    auto material_3 = make_shared<metal>(color(0.7, 0.6, 0.5), 0.0);
    world.add(make_shared<sphere>(point3(4.0, 1.0, 0.0), 1.0, material_3));
...
int main() {
    ...
    auto aperture = 0.1;
    camera cam(look_from, look_at, vup, 20.0, aspect_ratio, aperture, dist_to_focus);
